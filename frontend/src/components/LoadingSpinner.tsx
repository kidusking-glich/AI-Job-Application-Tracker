  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-8">
      <div className={`${sizeClasses[size]} relative`}>
        <div className="absolute inset-0 rounded-full border-4 border-gray-300 dark:border-white/10" />
      ...
      {text && <p className="text-sm text-gray-600 dark:text-gray-400 animate-pulse-soft">{text}</p>}
    </div>
  );
}
