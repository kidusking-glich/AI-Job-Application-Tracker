  ...
  return (
    <div className="mt-10 glass-card rounded-2xl overflow-hidden animate-fade-in relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-6 p-6 sm:p-8">
        ...
        <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 rounded-2xl bg-white dark:bg-white/10 border border-emerald-500/40 shadow-flag-glow">
          <span className="text-2xl font-display font-bold text-emerald-600 dark:text-emerald-400">ቴ</span>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">{SUPPORT_MESSAGE}</p>
        </div>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <button
            ...
            className="px-5 py-3 rounded-xl border border-emerald-500/50 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 font-semibold hover:bg-emerald-500 hover:text-white active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-emerald-500/10 disabled:hover:text-emerald-700 dark:disabled:hover:text-emerald-300"
          >
            {copied ? '✓ Copied' : '📋 Copy'}
          </button>
          <div className="text-center">
            <p className="text-2xl font-bold tracking-wide text-gray-900 dark:text-white">{TELEBIRR_PHONE}</p>
