...
function ErrorState({
  ...
  return (
    <div className="page-container text-center py-16 animate-fade-in">
      ...
      >
        <svg
          className={`w-10 h-10 ${isWarning ? 'text-ethiopian-yellow' : 'text-[#fb7185]'}`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <h2 className={`text-xl font-bold mb-2 ${isWarning ? 'text-ethiopian-yellow' : 'text-white'}`}>
        {displayTitle}
      </h2>
      <p className="text-gray-400 mb-6 max-w-md mx-auto">{displayMessage}</p>
...
function LanguageToggle({
  ...
  return (
    <div className="inline-flex rounded-xl border border-white/15 overflow-hidden bg-white/5 backdrop-blur-sm">
      <button
    ...
    return (
      <div className="page-container text-center py-16 animate-fade-in">
        ...
        <p className="text-gray-400 max-w-md mx-auto mb-2">
          Our AI is carefully reviewing each clause in <strong className="text-gray-200">{analysis.contract?.title}</strong>
        </p>
    ...
    <div className="page-container animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-2 text-sm text-gray-400">
          <Link to="/" className="hover:text-[#4ade80] transition-colors">Dashboard</Link>
          <span>→</span>
          <span className="text-gray-200">{analysis.contract?.title}</span>
        </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
              ...
              <div className="p-3 bg-ethiopian-yellow/10 border border-ethiopian-yellow/25 rounded-xl">
                <p className="text-2xl font-bold text-ethiopian-yellow">{clauseAnalyses.length}</p>
              ...
              <ul className="space-y-2">
                {recommendations.map((rec, i) => (
                  <li
                    ...
                    className="flex items-start gap-2 text-sm text-gray-300"
                  >
                    <span className="text-ethiopian-yellow mt-0.5">→</span>
                    <span>{rec}</span>
                  </li>
                ))}
              </ul>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <button
            ...
            className="px-4 py-2 bg-white/5 rounded-xl border border-white/15 text-sm font-medium text-gray-300 hover:border-ethiopian-green/60 hover:text-white transition-colors"
          >
          ...
          {badClauses.length > 0 && (
            <button
              ...
              className="px-4 py-2 bg-ethiopian-red/10 rounded-xl border border-ethiopian-red/30 text-sm font-medium text-[#fb7185] hover:bg-ethiopian-red/20 transition-colors"
            >
          ...
          {goodClauses.length > 0 && (
            <button
              ...
              className="px-4 py-2 bg-ethiopian-green/10 rounded-xl border border-ethiopian-green/30 text-sm font-medium text-[#4ade80] hover:bg-ethiopian-green/20 transition-colors"
            >
        ...
        {badClauses.length > 0 && (
          <div id="bad-clauses" className="mb-8">
            <h3 className="text-lg font-semibold text-[#fb7185] mb-4 flex items-center gap-2">
        ...
        {goodClauses.length > 0 && (
          <div id="good-clauses" className="mb-8">
            <h3 className="text-lg font-semibold text-[#4ade80] mb-4 flex items-center gap-2">
