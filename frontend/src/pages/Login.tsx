        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <form onSubmit={mfaToken ? handleVerify2fa : handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-end -mt-2">
              <Link to="/forgot-password" className="text-sm text-[#4ade80] font-semibold hover:underline hover:text-emerald-300 transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          {showResend && (
            <div className="mt-5 p-4 bg-ethiopian-yellow/10 border border-ethiopian-yellow/30 rounded-xl text-sm animate-fade-in">
              <p className="text-ethiopian-yellow font-medium mb-2">📧 Haven't verified your email?</p>
              {resendMessage && (
                <p className="text-gray-300 mb-2">{resendMessage}</p>
              )}
              <button
                onClick={handleResend}
                disabled={resending}
                className="text-[#4ade80] font-semibold hover:underline disabled:opacity-50"
              >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/signup" className="text-[#4ade80] font-semibold hover:underline transition-colors">
                Sign up
              </Link>
            </p>
          </div>
